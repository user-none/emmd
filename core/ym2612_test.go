...
func TestYM2612_BusWriteFromM68K(t *testing.T) {
	...
	bus.Write8(0xA04000, 0x2B) // Latch $2B (DAC enable)
	// Write data: 0xA04001 = port 1
	bus.Write8(0xA04001, 0x80) // Enable DAC
...
func TestYM2612_BusWordWriteFromM68K(t *testing.T) {
	...
	bus.Write16(0xA04000, 0x2B80) // Latch $2B, data $80 -> enable DAC
